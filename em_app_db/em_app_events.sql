...
CREATE TABLE `events` (
  ...
  PRIMARY KEY (`id`),
  KEY `category_relation` (`category`),
  CONSTRAINT `category_relation` FOREIGN KEY (`category`) REFERENCES `category` (`category`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `events` VALUES (1,'abc','aba','2025-04-30 16:29:03',NULL,'Wedding');
